...
class SciQualifierChipListComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.0.0", ngImport: i0, type: SciQualifierChipListComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.0.0", type: SciQualifierChipListComponent, isStandalone: true, selector: "sci-qualifier-chip-list", inputs: { type: { classPropertyName: "type", publicName: "type", isSignal: true, isRequired: false, transformFunction: null }, qualifier: { classPropertyName: "qualifier", publicName: "qualifier", isSignal: true, isRequired: false, transformFunction: null } }, ngImport: i0, template: "<ul>\n  @if (type()) {\n    <li class=\"type\">\n      <span class=\"type e2e-type\">{{type()}}</span>\n    </li>\n  }\n  @for (entry of (qualifier() ?? {}) | keyvalue:qualifierKeyCompareFn; track entry) {\n    <li class=\"e2e-qualifier-entry\">\n      <span class=\"key e2e-key\">{{entry.key}}</span>\n      <span class=\"value e2e-value\">{{entry.value}}</span>\n    </li>\n  }\n</ul>\n", styles: ["@charset \"UTF-8\";:host>ul{list-style:none;padding:0;margin:0;display:flex}:host>ul>li{border:1px solid var(--sci-color-border);background-color:var(--sci-qualifier-chip-list-qualifier-background-color, initial);color:var(--sci-color-text);border-radius:var(--sci-corner-small);font-size:smaller;-webkit-user-select:none;user-select:none;margin-bottom:.25em;display:flex;flex-direction:column;align-items:center;padding:.25em 1em}:host>ul>li:not(:last-child){margin-right:.25em}:host>ul>li>span.key{color:var(--sci-color-text-subtle)}:host>ul>li:before{display:block;content:\"\\abqualifier\\bb\";font-size:smaller;margin-bottom:.75em;color:var(--sci-color-text-subtlest)}:host>ul>li.type{border:1px solid var(--sci-color-border);background-color:var(--sci-qualifier-chip-list-type-background-color, var(--sci-color-gray-100));color:var(--sci-color-text);border-radius:var(--sci-corner-small);padding:.25em .5em;font-size:smaller;-webkit-user-select:none;user-select:none;margin-bottom:.25em;min-width:75px}:host>ul>li.type:not(:last-child){margin-right:.25em}:host>ul>li.type>span.type{font-size:1.5em;font-variant:small-caps;font-weight:700}:host>ul>li.type:before{content:\"\\abtype\\bb\";color:var(--sci-color-text-subtlest)}\n"], dependencies: [{ kind: "pipe", type: KeyValuePipe, name: "keyvalue" }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.0.0", ngImport: i0, type: SciQualifierChipListComponent, decorators: [{
            type: Component,
