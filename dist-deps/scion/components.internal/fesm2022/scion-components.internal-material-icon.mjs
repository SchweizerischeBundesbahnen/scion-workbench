...
class SciMaterialIconDirective {
    materialIcons = true;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.0.0", ngImport: i0, type: SciMaterialIconDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.0.0", type: SciMaterialIconDirective, isStandalone: true, selector: "[sciMaterialIcon]", host: { properties: { "class.material-icons": "this.materialIcons", "class.material-icons-outlined": "this.materialIcons", "class.material-icons-round": "this.materialIcons", "class.material-icons-sharp": "this.materialIcons", "class.material-symbols-sharp": "this.materialIcons", "class.material-symbols-outlined": "this.materialIcons", "class.material-symbols-rounded": "this.materialIcons" } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.0.0", ngImport: i0, type: SciMaterialIconDirective, decorators: [{
            type: Directive,
