...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.0.0", ngImport: i0, type: SciFormFieldComponent, decorators: [{
        ...
        }], ctorParameters: () => [], propDecorators: { isColumnDirection: [{
                type: HostBinding,
