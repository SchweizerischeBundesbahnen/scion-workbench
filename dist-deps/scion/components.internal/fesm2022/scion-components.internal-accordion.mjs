...
class SciAccordionItemDirective {
     ...
     */
    cssClass = input();
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.0.0", ngImport: i0, type: SciAccordionItemDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "20.0.0", type: SciAccordionItemDirective, isStandalone: true, selector: "ng-template[sciAccordionItem]", inputs: { panel: { classPropertyName: "panel", publicName: "panel", isSignal: true, isRequired: true, transformFunction: null }, key: { classPropertyName: "key", publicName: "key", isSignal: true, isRequired: false, transformFunction: null }, expanded: { classPropertyName: "expanded", publicName: "expanded", isSignal: true, isRequired: false, transformFunction: null }, cssClass: { classPropertyName: "cssClass", publicName: "cssClass", isSignal: true, isRequired: false, transformFunction: null } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.0.0", ngImport: i0, type: SciAccordionItemDirective, decorators: [{
            type: Directive,
...
class SciAccordionComponent {
    ...
    items = contentChildren(SciAccordionItemDirective);
    get isBubbleVariant() {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.0.0", ngImport: i0, type: SciAccordionComponent, decorators: [{
        ...
        }], propDecorators: { isBubbleVariant: [{
                type: HostBinding,
                args: ['class.bubble']
            }], isSolidVariant: [{
                type: HostBinding,
