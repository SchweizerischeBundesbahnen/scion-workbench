...
export interface RouteDescriptor {
  path: string;
  component: 'part-page' | 'view-page' | 'dialog-page' | 'popup-page' | 'messagebox-page' | 'notification-page' | 'router-page' | 'focus-test-page' | 'size-test-page' | 'text-test-page' | 'notification-param-reducer-test-page' | 'microfrontend-dialog-opener-page' | 'microfrontend-messagebox-opener-page' | 'microfrontend-popup-opener-page';
