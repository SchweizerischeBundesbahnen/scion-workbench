...
import {Component, computed, DoCheck, DOCUMENT, inject, Injector, NgZone, signal, Signal, WritableSignal} from '@angular/core';
...
export class AppComponent implements DoCheck {
  ...
  constructor() {
    ...
    contributeMenu('toolbar:microfrontend-toolbar', menu => menu
      .addMenu({label: 'Share', icon: 'person_add'}, menu => menu
