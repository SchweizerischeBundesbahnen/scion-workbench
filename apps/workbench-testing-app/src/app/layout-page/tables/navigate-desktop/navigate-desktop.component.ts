...
import {Commands, NavigationData} from '@scion/workbench';
...
export class NavigateDesktopComponent implements ControlValueAccessor, Validator {
  ...
  protected form = this._formBuilder.group({
    ...
    extras: this._formBuilder.group({
      ...
      data: this._formBuilder.control<NavigationData | undefined>(undefined),
      ...
      .subscribe(() => {
        this._cvaChangeFn({
          ...
          extras: {
            ...
            data: this.form.controls.extras.controls.data.value,
            cssClass: this.form.controls.extras.controls.cssClass.value,
          },
        });
        this._cvaTouchedFn();
      });
