...
export class RouterCommandsComponent implements ControlValueAccessor {
  ...
  constructor(private _router: Router, private _formBuilder: NonNullableFormBuilder) {
    ...
    this.formControl.valueChanges
      ...
      .subscribe(() => {
        this._cvaChangeFn(this.parseCommands(this.formControl.value));
        this._cvaTouchedFn();
      });
  }

  private parseCommands(value: string): Commands {
  ...
  private stringifyCommands(commands: Commands | null | undefined): string {
  ...
  public writeValue(commands: Commands | undefined | null): void {
    this.formControl.setValue(this.stringifyCommands(commands), {emitEvent: false});
  }
