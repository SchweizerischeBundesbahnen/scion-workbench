...
@Component({
  ...
  templateUrl: './host-router-page.component.html',
  styleUrls: ['./host-router-page.component.scss'],
  imports: [
    ReactiveFormsModule,
...
export default class HostRouterPageComponent {
  ...
  constructor() {
    inject(WorkbenchView, {optional: true})?.signalReady();
  }
