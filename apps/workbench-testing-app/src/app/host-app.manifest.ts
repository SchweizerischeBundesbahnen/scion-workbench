...
function provideDialogCapabilityRoute(): Route {
  return {
    ...
    loadComponent: () => import('../app/dialog-page/dialog-page.component'),
  };
}
...
function provideMessageBoxCapabilityRoute(): Route {
  return {
    ...
    loadComponent: () => import('../app/message-box-page/message-box-page.component'),
  };
}
...
function providePopupCapabilityRoute(): Route {
  return {
    ...
    loadComponent: () => import('../app/popup-page/popup-page.component'),
  };
}
