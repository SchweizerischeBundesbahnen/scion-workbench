...
export class HeaderComponent {
  ...
  private contributeSettingsToolbar(): void {
    contributeMenu('toolbar:settings', toolbar => toolbar
      ...
      .addToolbarMenu({icon: 'scion.more_vertical', visualMenuIndicator: false, cssClass: 'e2e-settings-menu', menu: {filter: true}}, menu => {
  ...
  private contributeOpenGroup(menu: SciMenuFactory): void {
    menu.addGroup(group => group
      ...
      .addMenu({label: 'Open Application'}, menu => menu
  ...
  private contributeNavigateGroup(menu: SciMenuFactory): void {
    const blankWorkbenchPageActive = isActive('test-pages/blank-test-page', this._router, {queryParams: 'ignored'});
    menu.addGroup(group => group.addMenu({label: 'Navigate Primary Router Outlet'}, menu => menu
      .addMenuItem({
        ...
        disabled: computed(() => !blankWorkbenchPageActive()),
      ...
      .addMenuItem({
        ...
        disabled: blankWorkbenchPageActive,
  ...
  private contributeLoggingGroup(menu: SciMenuFactory): void {
    menu.addGroup(group => group
      .addMenu({label: 'Log Level'}, menu => menu
        .addMenuItem({
          label: 'Debug',
  ...
  private contributePerspectiveSwitcherMenu(toolbar: SciToolbarFactory): void {
    ...
    toolbar.addToolbarMenu(menuDescriptor, menu => {
    ...
    function contributePerspectiveMenuItems(group: SciMenuFactory, perspectives: WorkbenchPerspective[]): void {
      ...
      for (const perspective of perspectives) {
        group.addMenuItem({
          ...
          actions: actions => perspective.active() && actions.addToolbarButton({
            icon: 'undo',
