...
export class HeaderComponent {
  ...
  private contributeStartupMenuItems(): MenuItem[] {
    return [
      new MenuItem({
        text: 'Open in new Browser Tab (Lazy)',
      ...
      new MenuItem({
        text: 'Open in new Browser Tab (Standalone, Lazy)',
        onAction: () => this.openInNewWindow({standalone: true, launcher: 'LAZY'}),
      }),
      new MenuItem({
        text: 'Open in new Browser Tab (Standalone, App Initializer)',
  ...
  private contributePerspectiveSwitcherMenuItems(): Array<MenuItem | MenuItemSeparator> {
    const groupLabels = new Map<string, string>()
      ...
      .set('sample-layout-peripheral-parts', 'Layout with Peripheral Parts');
    ...
    [...this.workbenchService.perspectives()]
      ...
      // Add menu item group with menu items for each perspective.
