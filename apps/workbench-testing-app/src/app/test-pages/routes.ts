...
export const testPageRoutes: Routes = [
  ...
  ...standaloneComponentTestPageRoutes(),
  ...nonStandaloneComponentTestPageRoutes(),
];

/**
 * Routes for standalone component test pages.
 */
function standaloneComponentTestPageRoutes(): Routes {
  return [
    {
 ...
 */
function nonStandaloneComponentTestPageRoutes(): Routes {
  return [
    {
