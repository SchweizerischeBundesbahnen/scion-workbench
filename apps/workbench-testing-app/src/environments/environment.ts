...
const microfrontendPlatformConfig: MicrofrontendPlatformConfig = {
  ...
  applications: [
    ...
    {symbolicName: 'devtools', manifestUrl: 'https://microfrontend-platform-devtools-v2-1-0.scion.vercel.app/manifest.json', intentionCheckDisabled: true, scopeCheckDisabled: true},
  ],
};
