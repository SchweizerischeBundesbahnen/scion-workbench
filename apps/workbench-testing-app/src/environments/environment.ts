...
const microfrontendPlatformConfig: MicrofrontendPlatformConfig = {
  ...
  applications: [
    ...
    {symbolicName: 'devtools', manifestUrl: 'https://scion-microfrontend-platform-devtools-v1-2-0.vercel.app/assets/manifest.json', intentionCheckDisabled: true, scopeCheckDisabled: true},
  ],
};
