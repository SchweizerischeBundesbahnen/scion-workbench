...
export class AppComponent {
  ...
  //   );
  //
  //   console.log(`>>> AppComponent2 ${this.appSymbolicName}`);
  //
  //   // setTimeout(() => {
  ...
  protected onAction(): void {
    console.log('>>> CLIENT ACT2ION');
  }
}

export function toggleMultiFlag(flags: WritableSignal<Set<string>>, flag: string): void {
  flags.update(flags => {
