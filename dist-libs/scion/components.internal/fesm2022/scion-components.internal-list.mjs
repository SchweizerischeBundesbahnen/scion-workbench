...
class SciListItemDirective {
     ...
     */
    actions = input([], ...(ngDevMode ? [{ debugName: "actions", transform: (actions) => Arrays.coerce(actions) }] : [{ transform: (actions) => Arrays.coerce(actions) }]));
    template = inject(TemplateRef);
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.0-rc.1", ngImport: i0, type: SciListItemDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "21.0.0-rc.1", type: SciListItemDirective, isStandalone: true, selector: "ng-template[sciListItem]", inputs: { key: { classPropertyName: "key", publicName: "key", isSignal: true, isRequired: false, transformFunction: null }, actions: { classPropertyName: "actions", publicName: "actions", isSignal: true, isRequired: false, transformFunction: null } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.0-rc.1", ngImport: i0, type: SciListItemDirective, decorators: [{
            type: Directive,
            args: [{ selector: 'ng-template[sciListItem]' }]
        }], propDecorators: { key: [{ type: i0.Input, args: [{ isSignal: true, alias: "key", required: false }] }], actions: [{ type: i0.Input, args: [{ isSignal: true, alias: "actions", required: false }] }] } });
...
class SciListItemComponent {
    listItem = input.required(...(ngDevMode ? [{ debugName: "listItem" }] : []));
    style = input.required(...(ngDevMode ? [{ debugName: "style" }] : []));
...
class SciListComponent {
     ...
     */
    filterPosition = input(...(ngDevMode ? [undefined, { debugName: "filterPosition" }] : []));
    /**
     * Specifies whether to render list items or option items.
     */
    style = input('list-item', ...(ngDevMode ? [{ debugName: "style" }] : []));
    /**
     ...
     */
    filter = output();
    _listItemComponents = viewChildren(SciListItemComponent, ...(ngDevMode ? [{ debugName: "_listItemComponents" }] : []));
    _filterField = viewChild(SciFilterFieldComponent, ...(ngDevMode ? [{ debugName: "_filterField" }] : []));
    _focusKeyManager;
    listItems = contentChildren(SciListItemDirective, ...(ngDevMode ? [{ debugName: "listItems" }] : []));
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.0-rc.1", ngImport: i0, type: SciListComponent, decorators: [{
        ...
        }], ctorParameters: () => [], propDecorators: { filterPosition: [{ type: i0.Input, args: [{ isSignal: true, alias: "filterPosition", required: false }] }], style: [{ type: i0.Input, args: [{ isSignal: true, alias: "style", required: false }] }], tabindex: [{ type: i0.Input, args: [{ isSignal: true, alias: "tabindex", required: false }] }], selection: [{ type: i0.Output, args: ["selection"] }], filter: [{ type: i0.Output, args: ["filter"] }], _listItemComponents: [{ type: i0.ViewChildren, args: [i0.forwardRef(() => SciListItemComponent), { isSignal: true }] }], _filterField: [{ type: i0.ViewChild, args: [i0.forwardRef(() => SciFilterFieldComponent), { isSignal: true }] }], listItems: [{ type: i0.ContentChildren, args: [i0.forwardRef(() => SciListItemDirective), { isSignal: true }] }], componentTabindex: [{
                type: HostBinding,
                args: ['attr.tabindex']
            }], onKeydown: [{
                type: HostListener,
