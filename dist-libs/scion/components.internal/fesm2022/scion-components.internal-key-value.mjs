...
class SciKeyValueComponent {
    object = input(...(ngDevMode ? [undefined, { debugName: "object" }] : []));
    flattenedProperties = computed(() => {
        const object = this.object() ?? {};
        return untracked(() => this.flattenObject(object));
    }, ...(ngDevMode ? [{ debugName: "flattenedProperties" }] : []));
    /**
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.0-rc.1", ngImport: i0, type: SciKeyValueComponent, decorators: [{
        ...
        }], propDecorators: { object: [{ type: i0.Input, args: [{ isSignal: true, alias: "object", required: false }] }] } });
