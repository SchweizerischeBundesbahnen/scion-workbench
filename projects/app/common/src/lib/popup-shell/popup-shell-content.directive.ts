...
/**
 * Use this directive to model the content for {SciPopupComponent}.
 ...
 * </sci-popup-shell>
 */
@Directive({selector: 'ng-template[sciPopupShellContent]'})
export class SciPopupShellContentDirective {
