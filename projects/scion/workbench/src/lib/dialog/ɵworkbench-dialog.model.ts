...
export class ɵWorkbenchDialog implements WorkbenchDialog, Blockable, Blocking {
  ...
  public registerHeader(header: WorkbenchDialogHeaderDirective): Disposable {
    ...
    return {
      dispose: () => this.header.update(currentHeader => currentHeader === header ? undefined : currentHeader),
    };
  }
  ...
  public registerFooter(footer: WorkbenchDialogFooterDirective): Disposable {
    ...
    return {
      dispose: () => this.footer.update(currentFooter => currentFooter === footer ? undefined : currentFooter),
    };
  }
