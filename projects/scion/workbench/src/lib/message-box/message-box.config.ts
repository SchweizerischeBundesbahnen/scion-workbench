 ...
 *   if opening the message box in the context of a view, it is opened as a view-modal message box. If opened outside a view,
 *   setting the modality to 'view' has no effect, unless setting {@link MessageBoxConfig.context.viewId}.
 */
