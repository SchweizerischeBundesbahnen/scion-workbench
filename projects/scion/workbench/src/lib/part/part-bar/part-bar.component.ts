...
export class PartBarComponent {
  ...
  private readonly _viewTabBar = viewChild.required(ViewTabBarComponent, {read: ElementRef<HTMLElement>});
  ...
  private calculateMaxViewTabBarWidth(): Signal<number> {
    ...
    return computed(() => viewTabBarDimension().offsetWidth + fillerDimension().offsetWidth);
  }
}
