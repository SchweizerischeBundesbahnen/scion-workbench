...
describe('WorkbenchPart', () => {
  ...
  describe('Part Bar', () => {
    ...
    it('should show title only for "top-left" part in activity', async () => {
      TestBed.configureTestingModule({
        providers: [
          provideWorkbenchForTest({
            layout: factory => factory
              .addPart(MAIN_AREA)
              .addPart('part.activity-top', {dockTo: 'left-top'}, {title: 'ACTIVITY TOP', label: 'Activity', icon: 'folder'})
              .addPart('part.activity-bottom', {relativeTo: 'part.activity-top', align: 'bottom'}, {title: 'ACTIVITY BOTTOM'})
      ...
      expect(fixture.debugElement.query(By.css('wb-part[data-partid="part.activity-top"] > wb-part-bar > span.e2e-title')).nativeElement.innerText).toEqual('ACTIVITY TOP');
