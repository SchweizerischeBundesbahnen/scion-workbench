...
import {provideMenuAcceleratorTargetProvider, provideMenuContextProvider, provideMenuInjectionContextProvider} from '@scion/components/menu';
  ...
  return [
    ...
    provideMenuContextProvider(callingInjector => runInInjectionContext(callingInjector, () => {
      ...
      return part && computed(() => new Map()
        ...
        .set(WorkbenchMenuContexts.ViewId, PART_NULL_ACTIVE_VIEW_ID) // Prevent contribution of part-content specific menus to the active view.
