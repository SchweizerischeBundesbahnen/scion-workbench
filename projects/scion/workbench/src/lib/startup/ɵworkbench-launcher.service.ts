  ...
  public async launch(): Promise<true> {
    ...
    switch (this.state()) {
      case LaunchState.Stopped: {
        console.log('>>> running WORKBENCH STARTING');
