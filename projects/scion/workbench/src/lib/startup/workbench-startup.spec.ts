...
describe('Workbench Startup', () => {
  ...
  it('should run initializers in following order: WORKBENCH_PRE_STARTUP > WORKBENCH_STARTUP > WORKBENCH_POST_STARTUP', async () => {
    ...
    expect(workbenchStartupFn1a).toHaveBeenCalledTimes(0);
    expect(workbenchStartupFn1b).toHaveBeenCalledTimes(0);
    expect(workbenchStartupFn2a).toHaveBeenCalledTimes(0);
    expect(workbenchStartupFn2b).toHaveBeenCalledTimes(0);
    ...
    expect(workbenchStartupFn1a).toHaveBeenCalledOnceWith();
    expect(workbenchStartupFn1b).toHaveBeenCalledOnceWith();
    expect(workbenchStartupFn2a).toHaveBeenCalledOnceWith();
    expect(workbenchStartupFn2b).toHaveBeenCalledOnceWith();
