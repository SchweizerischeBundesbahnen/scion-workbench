...
import {assertNotInReactiveContext, computed, inject, Injectable} from '@angular/core';
...
export class ɵWorkbenchService implements WorkbenchService {
  ...
  public readonly layout = computed(() => this._layoutService.layout() ?? throwError('[NullLayoutError] Workbench layout not created yet.'));
