...
describe('Text Provider', () => {
  ...
  it('should replace params', () => {
    ...
    expect(text1).toEqual('The requested page <strong>{{path}}</strong> was not found.<br>The URL may have changed.');
    ...
    expect(text2).toEqual('The requested page <strong>path/to/view</strong> was not found.<br>The URL may have changed.');
  });
