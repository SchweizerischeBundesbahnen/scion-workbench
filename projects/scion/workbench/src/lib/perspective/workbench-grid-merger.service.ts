...
export class WorkbenchGridMerger {
  ...
  public merge(grids: {local: ɵWorkbenchLayout; remote: ɵWorkbenchLayout; base: ɵWorkbenchLayout}): ɵWorkbenchLayout {
    const serializedBaseLayout = grids.base.serialize({excludeTreeNodeId: true, excludeViewNavigationId: true});
    const serializedRemoteLayout = grids.remote.serialize({excludeTreeNodeId: true, excludeViewNavigationId: true});
