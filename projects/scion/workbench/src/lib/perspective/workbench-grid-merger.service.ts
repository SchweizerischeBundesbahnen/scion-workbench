...
export class WorkbenchGridMerger {
  ...
  public merge(grids: {local: ɵWorkbenchLayout; remote: ɵWorkbenchLayout; base: ɵWorkbenchLayout}): ɵWorkbenchLayout {
    const serializedBaseLayout = grids.base.serialize({excludeNodeId: true, excludeViewUid: true, excludeViewNavigationId: true});
    const serializedRemoteLayout = grids.remote.serialize({excludeNodeId: true, excludeViewUid: true, excludeViewNavigationId: true});
