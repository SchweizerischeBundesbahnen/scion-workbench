...
describe('WorkbenchPerspectiveViewConflictResolver', () => {
  ...
  it('should resolve view conflicts when switching perspective', async () => {
    ...
    expect(fixture.debugElement.query(By.css('wb-part[data-partid="part.main"] wb-view[data-viewid="view.1"] spec-test-component')).nativeElement.innerText).toEqual('b');
