  ...
  it('allows moving a view in the tabbar', async () => {
    ...
    TestBed.inject(ViewDragService).dispatchViewMoveEvent({
      source: {
        ...
        partId: 'main',
        viewId: 'view.3',
        viewUrlSegments: [new UrlSegment('path', {}), new UrlSegment('to', {}), new UrlSegment('view', {})],
      },
      target: {
        workbenchId: TestBed.inject(WORKBENCH_ID),
        elementId: 'main',
  ...
  it('allows to move a view to a new part in the east', async () => {
    ...
    TestBed.inject(ViewDragService).dispatchViewMoveEvent({
      source: {
        ...
        partId: 'main',
        viewId: 'view.2',
        viewUrlSegments: [new UrlSegment('path', {}), new UrlSegment('to', {}), new UrlSegment('view', {}), new UrlSegment('2', {})],
      },
      target: {
        workbenchId: TestBed.inject(WORKBENCH_ID),
        elementId: 'main',
  ...
  it('allows to move views to another part', async () => {
    ...
    TestBed.inject(ViewDragService).dispatchViewMoveEvent({
      source: {
        ...
        partId: 'main',
        viewId: 'view.3',
        viewUrlSegments: [new UrlSegment('path', {}), new UrlSegment('to', {}), new UrlSegment('view', {}), new UrlSegment('3', {})],
      },
      target: {
        workbenchId: TestBed.inject(WORKBENCH_ID),
        elementId: 'main',
    ...
    TestBed.inject(ViewDragService).dispatchViewMoveEvent({
      source: {
        ...
        partId: 'main',
        viewId: 'view.1',
        viewUrlSegments: [new UrlSegment('path', {}), new UrlSegment('to', {}), new UrlSegment('view', {}), new UrlSegment('1', {})],
      },
      target: {
        workbenchId: TestBed.inject(WORKBENCH_ID),
        elementId: 'EAST',
  ...
  it('should open views to the right and to the left, and then close them', async () => {
    ...
    TestBed.inject(ViewDragService).dispatchViewMoveEvent({
      source: {
        ...
        partId: 'EAST-2',
        viewId: 'view.4',
        viewUrlSegments: [new UrlSegment('path', {}), new UrlSegment('to', {}), new UrlSegment('view', {}), new UrlSegment('4', {})],
      },
      target: {
        workbenchId: TestBed.inject(WORKBENCH_ID),
        elementId: 'main',
