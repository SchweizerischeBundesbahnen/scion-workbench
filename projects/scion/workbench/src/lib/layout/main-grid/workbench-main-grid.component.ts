 ...
 */
@Component({
  selector: 'wb-main-grid',
  templateUrl: './workbench-main-grid.component.html',
  styleUrls: ['./workbench-main-grid.component.scss'],
  standalone: true,
  imports: [
    RouterOutlet,
...
export class WorkbenchMainGridComponent {
  ...
  protected readonly grid = computed((): MPartGrid | undefined => {
    ...
    return layout && layout.maximized && layout.grids.mainArea ? layout.grids.mainArea : layout?.grids.main;
  });
