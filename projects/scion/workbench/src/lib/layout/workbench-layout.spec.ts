...
describe('WorkbenchLayout', () => {
  ...
  describe('Activity (Docked Parts)', () => {
    ...
    it('should close activity when removing last view', () => {
      ...
      expect(changedLayout.activityGroup({activityId: 'activity.1'}).activeActivityId).toBeUndefined();
    });
    ...
    it('should not close activity when removing last view (part has navigation)', () => {
      ...
      expect(changedLayout.activityGroup({activityId: 'activity.1'}).activeActivityId).toEqual('activity.1');
    ...
    it('should not open activity when removing last view', () => {
      ...
      // Expect activity to be closed.
      expect(workbenchLayout.activityGroup({activityId: 'activity.1'}).activeActivityId).toBeUndefined();
