...
export class WorkbenchLayoutService {
  ...
  /**
   * Indicates if the layout is being changed via drag and drop, such as moving a view or dialog, or resizing a part.
   */
  public readonly dragging = computed(() => this._viewDragService.dragging() || this._dragging());

  /**
   * Signals the start or end of layout changes via drag and drop, such as moving a view or dialog, or resizing a part.
   */
