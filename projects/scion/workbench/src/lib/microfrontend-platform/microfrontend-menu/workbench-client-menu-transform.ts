        ...
        case 'menu': {
          return {
            ...
            filter: menuItemProxy.filter && {
              placeholder: menuItemProxy.filter.placeholder && toSignal(menuItemProxy.filter.placeholder, {injector, requireSync: true}),
              notFoundText: menuItemProxy.filter.notFoundText && toSignal(menuItemProxy.filter.notFoundText, {injector, requireSync: true}),
      ...
      switch (menuItem.type) {
        ...
        case 'menu': {
          ...
          return new WorkbenchMenu({
            ...
            minWidth: menuItem.minWidth,
            maxWidth: menuItem.maxWidth,
            maxHeight: menuItem.maxHeight,
            filter: menuItem.filter && {
              placeholder: toLazyObservable(menuItem.filter.placeholder, {injector}),
              notFoundText: toLazyObservable(menuItem.filter.notFoundText, {injector}),
              focus: menuItem.filter.focus,
            },
            cssClass: menuItem.cssClass,
