    ...
    switch (menuItemProxy.type) {
      ...
      case 'menu': {
        const menuDescriptor: SciMenuDescriptor = {
          ...
          icon: menuItemProxy.icon && toSignal(menuItemProxy.icon, {requireSync: true}),
          disabled: menuItemProxy.disabled && toSignal(menuItemProxy.disabled, {requireSync: true}),
          width: menuItemProxy.width,
          minWidth: menuItemProxy.minWidth,
          maxWidth: menuItemProxy.maxWidth,
          maxHeight: menuItemProxy.maxHeight,
          filter: menuItemProxy.filter && {
            placeholder: menuItemProxy.filter.placeholder && toSignal(menuItemProxy.filter.placeholder, {requireSync: true}),
            notFoundText: menuItemProxy.filter.notFoundText && toSignal(menuItemProxy.filter.notFoundText, {requireSync: true}),
            focus: menuItemProxy.filter.focus,
          } as boolean | RequireOne<{placeholder?: MaybeSignal<Translatable>; notFoundText?: MaybeSignal<Translatable>; focus?: boolean}> | undefined,
          cssClass: menuItemProxy.cssClass,
        };
      ...
      case 'menu': {
        const menuDescriptor: SciToolbarMenuDescriptor = {
          ...
          filter: menuItemProxy.filter && {
            ...
            notFoundText: menuItemProxy.filter.notFoundText && toSignal(menuItemProxy.filter.notFoundText, {requireSync: true}),
            focus: menuItemProxy.filter.focus,
          } as boolean | RequireOne<{placeholder?: MaybeSignal<Translatable>; notFoundText?: MaybeSignal<Translatable>; focus?: boolean}>,
          cssClass: menuItemProxy.cssClass,
        };
