...
import {MicrofrontendPlatformInitializerFn, MicrofrontendPlatformStartupPhase, provideMicrofrontendPlatformInitializer} from '../microfrontend-platform/microfrontend-platform-initializer.provider';
...
describe('Microfrontend Platform Initializer', () => {
  ...
  it('should run microfrontend initializers if microfrontend support is enabled', async () => {
    ...
    expect(microfrontendPlatformPreStartupFn).toHaveBeenCalledOnceWith();
    expect(microfrontendPlatformPostStartupFn1).toHaveBeenCalledOnceWith();
    expect(microfrontendPlatformPostStartupFn2).toHaveBeenCalledOnceWith();
