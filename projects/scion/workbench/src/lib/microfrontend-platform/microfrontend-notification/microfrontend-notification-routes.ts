 ...
 */
export function provideMicrofrontendTextNotificationRoute(): EnvironmentProviders {
  return makeEnvironmentProviders([
    {
      provide: WORKBENCH_ROUTE,
      useFactory: (): Route => ({
        path: '',
        loadComponent: () => import('../microfrontend-host-notification/notification-text-message/notification-text-message.component'),
