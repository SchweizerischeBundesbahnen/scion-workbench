...
/**
 * Navigates to the microfrontend of a given {@link WorkbenchMessageBoxCapability} via {@link OutletRouter}. The content is displayed inside a workbench message box.
 */
@Component({
...
export class MicrofrontendMessageBoxComponent implements OnInit, OnDestroy {
  ...
  public readonly outletId = UUID.randomUUID();
  ...
  public ngOnDestroy(): void {
    this._outletRouter.navigate(null, {outlet: this.outletId}).then(); // Clear the outlet.
  }
}
