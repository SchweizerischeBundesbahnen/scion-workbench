...
import {MicrofrontendPlatformStartupPhase, runMicrofrontendPlatformInitializers} from '../microfrontend-platform-initializer.provider';
...
export class MicrofrontendPlatformInitializer implements OnDestroy {
  ...
  public async init(): Promise<void> {
    ...
    // Inject services registered in {MicrofrontendPlatformStartupPhase.PreStartup} phase.
