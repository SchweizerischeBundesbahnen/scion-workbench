...
describe('RemoteTextProvider', () => {
  ...
  describe('createRemoteTranslatable', () => {
    ...
    it('should add app to key', () => {
      ...
      expect(translatable).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key');
    });

    it('should include params', () => {
      const translatable = createRemoteTranslatable('%key;param1=value1;param2=value2', {appSymbolicName: 'app'});
      expect(translatable).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key;param1=value1;param2=value2');
    });
    ...
    it('should substitute named interpolation parameters', () => {
      ...
      expect(translatable1).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key;param1=VALUE1;param2=value2');
      ...
      expect(translatable2).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key;param1=value1;param2=VALUE2');
      ...
      expect(translatable3).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key;param1=VALUE1;param2=VALUE2');
    });
    ...
    it('should not substitute partial named interpolation parameters', () => {
      ...
      expect(translatable1).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key;param1=abc:value1;param2=VALUE2');
      ...
      expect(translatable2).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key;param1=:value1abc;param2=VALUE2');
      ...
      expect(translatable3).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key;param1=VALUE1;param2=abc:value2');
      ...
      expect(translatable4).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key;param1=VALUE1;param2=:value2abc');
    });
    ...
    it('should substitute named topic interpolation parameters', () => {
      ...
      expect(translatable).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key;param1=topic://a/b/c;param2=value2');
    });
    ...
    it('should not substitute partial named topic interpolation parameters', () => {
      ...
      expect(translatable1).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key;param1=abc:value1;param2=topic://d/e/f');
      ...
      expect(translatable2).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key;param1=:value1abc;param2=topic://d/e/f');
      ...
      expect(translatable3).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key;param1=topic://a/b/c;param2=abc:value2');
      ...
      expect(translatable4).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key;param1=topic://a/b/c;param2=:value2abc');
    });
    ...
    it('should substitute named topic segments', () => {
      ...
      expect(translatable1).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key;param1=topic://ENTITY/b/c;param2=value2');
      ...
      expect(translatable2).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key;param1=topic://a/ID/c;param2=value2');
    });
    ...
    it('should not substitute unkown named topic segments', () => {
      ...
      expect(translatable).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key;param1=topic://a/:id/c;param2=value2');
    });
    ...
    it('should not substitute partial named topic segments', () => {
      ...
      expect(translatable1).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key;param1=topic://a:id/b/c;param2=value2');
      ...
      expect(translatable2).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key;param1=topic://:ida/b/c;param2=value2');
      ...
      expect(translatable3).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key;param1=topic://a/b:id/c;param2=value2');
      ...
      expect(translatable4).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key;param1=topic://a/:idb/c;param2=value2');
    });
    ...
    it('should append parameters to non-translatable text', () => {
      ...
      expect(translatable1a).toEqual('%scion.workbench.internal.scion-workbench-client.app.:id;id=123');

      const translatable1b = createRemoteTranslatable('Start :id End', {appSymbolicName: 'app', valueParams: {id: '123'}});
      expect(translatable1b).toEqual('%scion.workbench.internal.scion-workbench-client.app.Start :id End;id=123');

      const translatable2a = createRemoteTranslatable(':name', {appSymbolicName: 'app', topicParams: {name: 'a/b/c'}});
      expect(translatable2a).toEqual('%scion.workbench.internal.scion-workbench-client.app.:name;name=topic://a/b/c');

      const translatable2b = createRemoteTranslatable('Start :name End', {appSymbolicName: 'app', topicParams: {name: 'a/b/c'}});
      expect(translatable2b).toEqual('%scion.workbench.internal.scion-workbench-client.app.Start :name End;name=topic://a/b/c');

      const translatable3a = createRemoteTranslatable(':name', {appSymbolicName: 'app', valueParams: {id: '123'}, topicParams: {name: 'a/:id/c'}});
      expect(translatable3a).toEqual('%scion.workbench.internal.scion-workbench-client.app.:name;name=topic://a/123/c');
      ...
      expect(translatable3b).toEqual('%scion.workbench.internal.scion-workbench-client.app.Start :name End;name=topic://a/123/c');
      ...
      expect(translatable4b).toEqual('%scion.workbench.internal.scion-workbench-client.app.:param1 :param2 :param3;param1=123;param2=topic://a/b/c');
    });
    ...
    it('should escape semicolon in non-translatable text', () => {
      ...
      expect(translatable3).toEqual('%scion.workbench.internal.scion-workbench-client.app.A&#x3b:param&#x3bB;param=value');
    });
    ...
    it('should escape semicolon in parameters', () => {
      ...
      expect(translatable1).toEqual('%scion.workbench.internal.scion-workbench-client.app.:param;param=123&#x3b456');

      const translatable2 = createRemoteTranslatable('%key;param=:param', {valueParams: {param: '123;456'}, appSymbolicName: 'app'});
      expect(translatable2).toEqual('%scion.workbench.internal.scion-workbench-client.app.%key;param=123&#x3b456');
    });
  });
});
