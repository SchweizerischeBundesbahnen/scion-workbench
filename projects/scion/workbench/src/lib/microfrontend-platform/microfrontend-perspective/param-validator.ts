...
export class ParamValidator {
  ...
  public validatePartParams(params: Params | undefined, partCapability: Capability, context: {perspectiveCapability: Capability; partId: string}): Params | false {
    ...
    return this.validateParams(params, partCapability, {
      ...
      unexpected: param => `[PerspectiveDefinitionError] Perspective '${qualifier(perspectiveCapability)}' of app '${app(perspectiveCapability)}' passes the illegal parameter '${param}' to part '${partId}'. Pass parameters as specified in the capability documentation of part '${qualifier(partCapability)}'. Ignoring part.`,
    });
  }
  ...
  public validateViewParams(params: Params | undefined, viewCapability: Capability, context: {partCapability: Capability}): Params | false {
    ...
    return this.validateParams(params, viewCapability, {
      ...
      unexpected: param => `[PartDefinitionError] Part '${qualifier(partCapability)}' of app '${app(partCapability)}' passes the illegal parameter '${param}' to view '${qualifier(viewCapability)}'. Pass parameters as specified in the capability documentation. Ignoring view.`,
    });
  }
