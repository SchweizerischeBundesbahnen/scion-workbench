 ...
 * like the completed startup of the SCION Microfrontend Platform. Otherwise, microfrontends would display a "Not Found" page until the next Angular navigation.
 *
