...
import {provideWorkbenchMenu} from './microfrontend-menu/microfrontend-menu.provider';
import {provideWorkbenchMenuAdapter} from './microfrontend-menu/microfrontend-menu-adapter';
