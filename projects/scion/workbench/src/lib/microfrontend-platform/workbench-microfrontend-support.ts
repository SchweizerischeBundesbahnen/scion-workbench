...
import {providePerspectives} from './microfrontend-perspective/microfrontend-perspective.provider';
import {provideParts} from './microfrontend-part/microfrontend-part.provider';
