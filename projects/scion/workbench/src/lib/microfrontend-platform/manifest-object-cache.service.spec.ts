...
describe('ManifestObjectCache', () => {
  ...
  it('should observe capability', async () => {
    ...
    interceptCapability(capability => {
...
/**
 * Intercepts capabilities before their registration in the SCION Microfrontend Platform.
 */
function interceptCapability(fn: (capability: Capability) => Capability): void {
