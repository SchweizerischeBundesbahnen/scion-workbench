...
export class WorkbenchNotificationComponent {
  ...
  public readonly bounds = viewChild('bounds', {read: ElementRef<HTMLElement>});
...
function configureNotificationGlassPane(): Provider[] {
  return [
    ...
    },
    {
      ...
      useFactory: () => ({attributes: {'data-notificationid': inject(ɵWorkbenchNotification).id}}) satisfies GlassPaneOptions,
    },
  ];
}
