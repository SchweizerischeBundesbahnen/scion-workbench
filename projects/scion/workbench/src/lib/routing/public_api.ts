...
export {canMatchWorkbenchView, canMatchWorkbenchPerspective, canMatchWorkbenchPart, canMatchWorkbenchOutlet, canMatchWorkbenchHostPart} from './workbench-route-guards';
