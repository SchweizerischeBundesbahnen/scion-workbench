...
export class WorkbenchLayoutDiffer {
  ...
  public diff(workbenchLayout: ɵWorkbenchLayout | null, urlTree: UrlTree): WorkbenchLayoutDiff {
    ...
    // Create diff for views contained in URL for later registration of view routes.
    // We cannot create the diff based on the views contained in the layout because the layout is loaded asynchronously
    // and is not available during the initial navigation.
