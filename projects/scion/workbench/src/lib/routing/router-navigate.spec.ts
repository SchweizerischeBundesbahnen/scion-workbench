...
describe('Router', () => {
  ...
  it('allows for relative and absolute navigation', async () => {
    ...
    await workbenchRouter.navigate(['feature-a']);
 ...
 */
async function clickElement(appFixture: ComponentFixture<any>, viewType: Type<any>, elementSelector: string, failureMessage?: string): Promise<void> {
