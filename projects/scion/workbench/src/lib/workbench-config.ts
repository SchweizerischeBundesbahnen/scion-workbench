...
export abstract class WorkbenchConfig {
  ...
  /**
   * Provides texts to the SCION Workbench, enabling localization of texts.
   *
 ...
 * Configures a built-in menu item.
 *
 * @deprecated since version 22.0.0-beta.2. Use {MenuItemConfig} instead.
 */
export interface LegacyMenuItemConfig {
  /**
   * @deprecated since version 22.0.0-beta.2. Specify the accelerator as {SciKeyboardAccelerator} object instead.
   */
  accelerator?: string[];
  /**
   * @deprecated since version 22.0.0-beta.2. No replacement.
   */
  group?: string;
  cssClass?: string | string[];
}
