...
export class ViewDragService implements OnDestroy {
  ...
  /**
   * Notifies when to move a view. The event is broadcasted to all app instances of the same origin.
   */
  public readonly viewMove$: Observable<ViewMoveEvent> = this._viewMoveBroadcastChannel.observe$;

  /**
   * Notifies about the completion of moving a view in the layout of this app instance.
   */
  ...
  /**
   * Indicates if a drag operation is in progress in any app instance of the same origin.
   */
  public readonly dragging = computed<boolean>(() => this.viewDragData() !== null);

  /**
   * Signals when start dragging a tab over specified tabbar (dragenter).
   */
  ...
  /**
   * Signals when end dragging a tab over specified tabbar (dragleave).
   */
  ...
  /**
   * Signals the completion of moving a view in the layout of this app instance.
   */
  ...
  /**
   * Dispatches the given view move event to all app instances of the same origin.
   */
  public dispatchViewMoveEvent(event: ViewMoveEvent): void {
    // Dispatch the event after the current drag operation has ended, if any, preventing destruction of the drag source
  ...
  /**
   * Sets given drag data, broadcasting it to all app instances of the same origin.
   *
