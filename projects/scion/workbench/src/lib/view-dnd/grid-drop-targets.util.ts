 ...
 */
function resolve(target: {grid: MPartGrid; dropRegion: 'west' | 'east' | 'north' | 'south' | 'center'; workbenchId: string}): ViewMoveEventTarget {
 ...
 */
export const GridDropTargets = {resolve} as const;
