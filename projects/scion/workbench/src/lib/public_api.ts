...
export {type WorkbenchPartAction, type WorkbenchPartActionFn, type WorkbenchMenuItem, type WorkbenchViewMenuItemFn, type WorkbenchTheme, type CanCloseFn, type CanCloseRef, type WorkbenchElement, WORKBENCH_ELEMENT} from './workbench.model';
