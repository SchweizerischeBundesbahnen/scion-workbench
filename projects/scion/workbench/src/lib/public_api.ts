...
export {WorkbenchPartAction, WorkbenchPartActionFn, WorkbenchMenuItem, WorkbenchViewMenuItemFn, WorkbenchTheme, CanClose, CanCloseFn, CanCloseRef, ComponentDescriptor} from './workbench.model';
