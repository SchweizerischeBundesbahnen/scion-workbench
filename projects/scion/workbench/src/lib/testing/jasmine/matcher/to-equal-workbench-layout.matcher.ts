...
function assertActivityToolbarsDOM(expectedActivityLayout: Partial<MActivityLayout>, actualElement: Element): void {
  if (expectedActivityLayout.toolbars?.leftTop) {
    assertActivityItemsDOM(expectedActivityLayout.toolbars.leftTop, actualElement.querySelector('wb-layout > wb-activity-bar[data-align="left"] > wb-activity-group[data-group="left-top"]'), 'left-top');
  }
  if (expectedActivityLayout.toolbars?.leftBottom) {
    assertActivityItemsDOM(expectedActivityLayout.toolbars.leftBottom, actualElement.querySelector('wb-layout > wb-activity-bar[data-align="left"] > wb-activity-group[data-group="left-bottom"]'), 'left-bottom');
  }
  if (expectedActivityLayout.toolbars?.rightTop) {
    assertActivityItemsDOM(expectedActivityLayout.toolbars.rightTop, actualElement.querySelector('wb-layout > wb-activity-bar[data-align="right"] > wb-activity-group[data-group="right-top"]'), 'right-top');
  }
  if (expectedActivityLayout.toolbars?.rightBottom) {
    assertActivityItemsDOM(expectedActivityLayout.toolbars.rightBottom, actualElement.querySelector('wb-layout > wb-activity-bar[data-align="right"] > wb-activity-group[data-group="right-bottom"]'), 'right-bottom');
  }
  if (expectedActivityLayout.toolbars?.bottomLeft) {
    assertActivityItemsDOM(expectedActivityLayout.toolbars.bottomLeft, actualElement.querySelector('wb-layout > wb-activity-bar[data-align="left"] > wb-activity-group[data-group="bottom-left"]'), 'bottom-left');
  }
  if (expectedActivityLayout.toolbars?.bottomRight) {
    assertActivityItemsDOM(expectedActivityLayout.toolbars.bottomRight, actualElement.querySelector('wb-layout > wb-activity-bar[data-align="right"] > wb-activity-group[data-group="bottom-right"]'), 'bottom-right');
  }
}

function assertActivityItemsDOM(expectedGroup: MActivityGroup, actualElement: Element | null, group: 'left-top' | 'left-bottom' | 'right-top' | 'right-bottom' | 'bottom-left' | 'bottom-right'): void {
  if (expectedGroup.activities.length === 0) {
    actualElement && throwError(`[DOMAssertError] Expected activity group to not have activities, but it has. [group=${group}]`);
    return;
  }

  if (!actualElement) {
    throw Error(`[DOMAssertError] Expected activity group to be present, but is not. [group=${group}]`);
  }
