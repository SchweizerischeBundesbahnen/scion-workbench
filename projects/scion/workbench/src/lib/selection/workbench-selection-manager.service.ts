...
export abstract class WorkbenchSelectionManagerService {
  ...
  public abstract setSelection(selection: WorkbenchSelection, options: {workbenchObjectId: string}): void;

  public abstract deleteSelection(workbenchObjectId: string): void;
}
...
export type ɵWorkbenchSelection = {
