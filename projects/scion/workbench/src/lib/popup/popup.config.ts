 ...
 *
 * @deprecated since version 20.0.0-beta.10. Replaced by `WorkbenchPopupOptions`. Use `WorkbenchPopupService` to open popups. Marked for removal in version 22.
 */
export abstract class PopupConfig {
  ...
  public readonly componentConstructOptions?: {
     ...
     *
     * @deprecated since version 20.0.0-beta.10. Marked for removal. No replacement as not required anymore.
     */
