...
export interface WorkbenchPopupOptions {
   ...
   *
   * @deprecated since version 20.0.0-beta.10. Popup size should be set by the popup component. To migrate, inject `WorkbenchPopup` into the popup component and set the size via the `WorkbenchPopup.size` property. Marked for removal in version 22.
   */
  size?: {
    minHeight?: string;
    height?: string;
