...
export class ɵWorkbenchPopup implements WorkbenchPopup, Blockable {
  ...
  constructor(public id: PopupId,
    ...
    this.input = this._portal.injector?.get(LEGACY_POPUP_INPUT, null, {optional: true});
...
/**
 * @deprecated since version 20.0.0-beta.10. Used for backward compatiblity. Marked for removal in version 22.
 */
