...
export abstract class WorkbenchPopup {
   ...
   *
   * @deprecated since version 20.0.0-beta.10. Use `WorkbenchPopupService` to open popups. Inputs are available as input properties in the popup component. Marked for removal in version 22.
   */
  public abstract get input(): unknown | undefined;

  /**
   * Sets the preferred popup size. Defaults to the content's intrinsic size, constrained by min and max size, if set.
   *
   * If set, displays scrollbars if content overflows.
   */
  public abstract readonly size: WorkbenchPopupSize;

  /**
   * Specifies CSS class(es) to add to the popup, e.g., to locate the view in tests.
   */
   ...
   *
   * @deprecated since version 20.0.0-beta.10. Use `cssClass` instead. Marked for removal in version 22.
   */
