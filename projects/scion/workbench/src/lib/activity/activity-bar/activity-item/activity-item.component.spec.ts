...
describe('Activity Item Component', () => {
  ...
  it('should render default icon component', async () => {
    TestBed.configureTestingModule({
      providers: [
        provideWorkbenchForTest({
          layout: factory => factory
            .addPart(MAIN_AREA)
            .addPart('part.activity-1', {dockTo: 'left-top'}, {icon: 'testee-1', label: 'Activity', ɵactivityId: 'activity.1'})
            .addPart('part.activity-2', {dockTo: 'left-top'}, {icon: 'testee-2', label: 'Activity', ɵactivityId: 'activity.2'}),
        }),
      ],
    });
    ...
    expect(fixture.debugElement.query(By.css('wb-activity-item[data-activityid="activity.1"] wb-material-icon')).nativeElement.innerText).toEqual('testee-1');
    expect(fixture.debugElement.query(By.css('wb-activity-item[data-activityid="activity.2"] wb-material-icon')).nativeElement.innerText).toEqual('testee-2');
  });

  it('should render custom icon component', async () => {
    @Component({
    ...
    expect(fixture.debugElement.query(By.css('wb-activity-item[data-activityid="activity.1"] spec-testee-icon')).nativeElement.innerText).toEqual('testee-1');
    expect(fixture.debugElement.query(By.css('wb-activity-item[data-activityid="activity.2"] spec-testee-icon')).nativeElement.innerText).toEqual('testee-2');
  });
