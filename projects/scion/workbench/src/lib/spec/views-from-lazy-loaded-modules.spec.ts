...
describe('Views', () => {
  ...
  it('can be loaded from lazy feature modules', fakeAsync(inject([WorkbenchRouter], (workbenchRouter: WorkbenchRouter) => {
