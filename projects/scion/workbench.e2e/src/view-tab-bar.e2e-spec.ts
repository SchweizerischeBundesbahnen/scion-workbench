...
describe('ViewTabBar', () => {
  ...
  it('should insert a new view tab into the tabbar after the active view tab by default', async () => {
    await viewNavigationPO.navigateTo();
    await expect(appPO.getViewTabCount()).toEqual(1);
    await expect(appPO.getViewTabs()).toEqual(['view.1']);
    ...
    await expect(appPO.findViewTab({viewId: 'view.2'}).isActive()).toBeTruthy();
    await expect(appPO.getViewTabs()).toEqual(['view.1', 'view.2']);
    ...
    await expect(appPO.findViewTab({viewId: 'view.3'}).isActive()).toBeTruthy();
    await expect(appPO.getViewTabs()).toEqual(['view.1', 'view.3', 'view.2']);
    ...
    await expect(appPO.findViewTab({viewId: 'view.4'}).isActive()).toBeTruthy();
    await expect(appPO.getViewTabs()).toEqual(['view.1', 'view.4', 'view.3', 'view.2']);
  });
  ...
  it('should insert a new view tab into the tabbar at the end', async () => {
    ...
    await expect(appPO.findViewTab({viewId: 'view.3'}).isActive()).toBeTruthy();
    await expect(appPO.getViewTabs()).toEqual(['view.1', 'view.2', 'view.3']);
    ...
    await expect(appPO.findViewTab({viewId: 'view.4'}).isActive()).toBeTruthy();
    await expect(appPO.getViewTabs()).toEqual(['view.1', 'view.2', 'view.3', 'view.4']);
  });
  ...
  it('should insert a new view tab into the tabbar at the start', async () => {
    ...
    await expect(appPO.findViewTab({viewId: 'view.2'}).isActive()).toBeTruthy();
    await expect(appPO.getViewTabs()).toEqual(['view.2', 'view.1']);
    ...
    await expect(appPO.findViewTab({viewId: 'view.3'}).isActive()).toBeTruthy();
    await expect(appPO.getViewTabs()).toEqual(['view.3', 'view.2', 'view.1']);
    ...
    await expect(appPO.findViewTab({viewId: 'view.4'}).isActive()).toBeTruthy();
    await expect(appPO.getViewTabs()).toEqual(['view.4', 'view.3', 'view.2', 'view.1']);
  });
