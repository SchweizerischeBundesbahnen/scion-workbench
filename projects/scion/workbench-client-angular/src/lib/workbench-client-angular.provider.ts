...
import {WorkbenchClient, WorkbenchClientConfiguration, WorkbenchDialog, WorkbenchDialogService, WorkbenchMenuService, WorkbenchMessageBox, WorkbenchMessageBoxService, WorkbenchNotification, WorkbenchNotificationService, WorkbenchPart, WorkbenchPopup, WorkbenchPopupService, WorkbenchRouter, WorkbenchTextProviderFn, WorkbenchTextService, WorkbenchThemeMonitor, WorkbenchView, ɵWorkbenchMenuService} from '@scion/workbench-client';
