...
import {WorkbenchMenubarFactory, WorkbenchMenuFactory, WorkbenchMenuOrigin, WorkbenchToolbarFactory, ɵWorkbenchMenuService} from '@scion/workbench-client';
...
import {assertInInjectionContext, createDestroyableInjector, MaybeSignal, toLazyObservable} from '@scion/components/common';
...
function coerceFilterDescriptor(filter: SciMenuOptions['filter'] | undefined): {placeholder?: MaybeSignal<Translatable>; notFoundText?: MaybeSignal<Translatable>; focus?: boolean} | undefined {
