...
function coerceFilterDescriptor(menuDescriptor: SciMenuDescriptor): {placeholder?: MaybeSignal<Translatable>; notFoundText?: MaybeSignal<Translatable>; focus?: boolean} | undefined {
