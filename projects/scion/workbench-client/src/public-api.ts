...
export {WorkbenchPerspectiveCapability, WorkbenchPerspectivePartContribution} from './lib/perspective/workbench-perspective-capability';
export {WorkbenchPerspectiveExtensionCapability, WorkbenchPerspectiveViewContribution} from './lib/perspective/workbench-perspective-extension-capability';
