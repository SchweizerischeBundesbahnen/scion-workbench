...
export {WorkbenchPerspectiveCapability, WorkbenchPerspectivePart} from './lib/perspective/workbench-perspective-capability';
export {WorkbenchPerspectiveExtensionCapability, WorkbenchPerspectiveViewExtension} from './lib/perspective/workbench-perspective-extension-capability';
