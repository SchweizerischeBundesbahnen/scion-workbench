...
export {WorkbenchView, type CanClose, type CanCloseFn, type CanCloseRef, type ViewSnapshot, type ViewId} from './lib/view/workbench-view';
...
export {WorkbenchPopup, ɵWorkbenchPopupMessageHeaders, type PopupId} from './lib/popup/workbench-popup';
...
export {WorkbenchDialog, type DialogId} from './lib/dialog/workbench-dialog';
