...
export interface WorkbenchDialogCapability extends Capability {
   ...
   *
   * Parameters can be read in the microfrontend by injecting the {@link WorkbenchDialog} handle (or `ActivatedMicrofrontend` if a host microfrontend).
   * Parameters can also be referenced in the path, title and resolvers using the colon syntax.
   *
   * @inheritDoc
   */
