...
export interface WorkbenchDialogOptions {
  ...
  /**
   * Allows passing data to the dialog microfrontend. The dialog provider can declare mandatory and optional parameters.
   ...
   *
   * - **Application-modal:**
   *   Use to block the workbench, or the browser's viewport if configured in the workbench global options.
   *
   * - **View-modal:**
