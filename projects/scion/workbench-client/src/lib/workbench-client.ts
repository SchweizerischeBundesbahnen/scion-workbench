...
export class WorkbenchClient {
   ...
   *
   * @deprecated since version 1.0.0-beta.41. Marked for removal. To migrate, register a text provider via options object when connecting to the workbench using `WorkbenchClient.connect`. Angular applications using `@scion/workbench-client-angular` should register a text provider via `provideTextProvider` function.
   */
