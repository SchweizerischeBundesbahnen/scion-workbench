...
export class ɵWorkbenchToolbarFactory implements WorkbenchToolbarFactory {
  ...
  /** @inheritDoc */
  public addToolbarItem(icon: MaybeAsync<string>, onSelect: () => void): this;
  public addToolbarItem(descriptor: WorkbenchToolbarItemDescriptor): this;
  public addToolbarItem(iconOrDescriptor: MaybeAsync<string> | WorkbenchToolbarItemDescriptor, onSelect?: () => void): this {
    ...
    this.menuItems.push(new WorkbenchMenuItem({
      ...
      icon: coerceObservable(descriptor.icon),
  ...
  /** @inheritDoc */
  public addMenu(icon: MaybeAsync<string>, menuFactoryFn: (menu: WorkbenchMenuFactory) => void): this;
  public addMenu(descriptor: WorkbenchToolbarMenuDescriptor, menuFactoryFn: (menu: WorkbenchMenuFactory) => void): this;
  public addMenu(iconOrDescriptor: MaybeAsync<string> | WorkbenchToolbarMenuDescriptor, menuFactoryFn: (menu: WorkbenchMenuFactory) => void): this {
...
function coerceToolbarItemDescriptor(iconOrDescriptor: MaybeAsync<string> | WorkbenchToolbarItemDescriptor, onSelect?: () => void): WorkbenchToolbarItemDescriptor {
...
function coerceMenuDescriptor(iconOrDescriptor: MaybeAsync<string> | WorkbenchToolbarMenuDescriptor): WorkbenchToolbarMenuDescriptor {
  if (typeof iconOrDescriptor === 'string' || isObservable(iconOrDescriptor)) {
