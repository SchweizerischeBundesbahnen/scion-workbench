...
function coerceFilterDescriptor(menuDescriptor: WorkbenchToolbarMenuDescriptor): {placeholder?: MaybeObservable<Translatable>; notFoundText?: MaybeObservable<Translatable>; focus?: boolean} | undefined {
