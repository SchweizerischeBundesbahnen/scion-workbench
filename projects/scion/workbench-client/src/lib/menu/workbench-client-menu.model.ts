  ...
  public toTransferable$(): Observable<WorkbenchMenuTransferable> {
    ...
    return createRemoteObservable$({
      ...
      resolve: {
        ...
        filterPlaceholder: Observables.coerce(this._menu.filter?.placeholder),
        filterNotFoundText: Observables.coerce(this._menu.filter?.notFoundText),
      ...
      mapTo: ({label, icon, tooltip, disabled, children, filterPlaceholder, filterNotFoundText}): WorkbenchMenuTransferable => prune({
        ...
        minWidth: this._menu.minWidth,
        maxWidth: this._menu.maxWidth,
        maxHeight: this._menu.maxHeight,
        filter: this._menu.filter && {placeholder: filterPlaceholder, notFoundText: filterNotFoundText, focus: this._menu.filter.focus},
...
export class WorkbenchMenuProxy {
  ...
  public readonly filter?: {placeholder?: Observable<string>; notFoundText?: Observable<string>; focus?: boolean};
  public readonly cssClass?: string[];
  ...
  constructor(transferable: WorkbenchMenuTransferable) {
    ...
    this.position = transferable.position;
    this.width = transferable.width;
    this.minWidth = transferable.minWidth;
    this.maxWidth = transferable.maxWidth;
    this.maxHeight = transferable.maxHeight;
    this.filter = transferable.filter && {
      placeholder: remoteSubscriber$({relayId: this.id, property: 'filterPlaceholder', initialValue: transferable.filter.placeholder}),
      notFoundText: remoteSubscriber$({relayId: this.id, property: 'filterNotFoundText', initialValue: transferable.filter.notFoundText}),
      focus: transferable.filter.focus,
    };
    this.cssClass = transferable.cssClass;
