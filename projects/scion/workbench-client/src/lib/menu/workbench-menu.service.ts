import {WorkbenchMenuContributionLocation, WorkbenchMenuContributionOptions, WorkbenchMenuFactoryFn, WorkbenchMenuOptions, WorkbenchMenuRef, WorkbenchToolbarContributionLocation, WorkbenchToolbarFactoryFn} from './workbench-client-menu.model';
