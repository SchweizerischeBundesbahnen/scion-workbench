...
export class WorkbenchRouter {
   ...
   */
  public async navigate(qualifier: Qualifier | EmptyQualifier, extras?: WorkbenchNavigationExtras): Promise<boolean> {
  ...
  private async issueViewIntent(qualifier: Qualifier | EmptyQualifier, extras?: WorkbenchNavigationExtras): Promise<boolean> {
  ...
  private isSelfNavigation(qualifier: Qualifier | EmptyQualifier): boolean {
