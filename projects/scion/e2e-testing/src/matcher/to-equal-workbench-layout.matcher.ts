...
async function assertActivityToolbars(expectedActivityLayout: Partial<MActivityLayout>, locator: Locator): Promise<void> {
  if (expectedActivityLayout.toolbars?.leftTop) {
    await assertActivityItems(expectedActivityLayout.toolbars.leftTop, locator.locator('wb-layout > wb-activity-bar[data-align="left"] > wb-activity-group[data-group="left-top"]'));
  }
  if (expectedActivityLayout.toolbars?.leftBottom) {
    await assertActivityItems(expectedActivityLayout.toolbars.leftBottom, locator.locator('wb-layout > wb-activity-bar[data-align="left"] > wb-activity-group[data-group="left-bottom"]'));
  }
  if (expectedActivityLayout.toolbars?.rightTop) {
    await assertActivityItems(expectedActivityLayout.toolbars.rightTop, locator.locator('wb-layout > wb-activity-bar[data-align="right"] > wb-activity-group[data-group="right-top"]'));
  }
  if (expectedActivityLayout.toolbars?.rightBottom) {
    await assertActivityItems(expectedActivityLayout.toolbars.rightBottom, locator.locator('wb-layout > wb-activity-bar[data-align="right"] > wb-activity-group[data-group="right-bottom"]'));
  }
  if (expectedActivityLayout.toolbars?.bottomLeft) {
    await assertActivityItems(expectedActivityLayout.toolbars.bottomLeft, locator.locator('wb-layout > wb-activity-bar[data-align="left"] > wb-activity-group[data-group="bottom-left"]'));
  }
  if (expectedActivityLayout.toolbars?.bottomRight) {
    await assertActivityItems(expectedActivityLayout.toolbars.bottomRight, locator.locator('wb-layout > wb-activity-bar[data-align="right"] > wb-activity-group[data-group="bottom-right"]'));
  }
}

async function assertActivityItems(expectedGroup: MActivityGroup, locator: Locator): Promise<void> {
  if (expectedGroup.activities.length === 0) {
    await throwIfPresent(locator, () => Error(`[DOMAssertError] Expected activity group to not have activities, but it has. [locator=${locator}]`));
  }
