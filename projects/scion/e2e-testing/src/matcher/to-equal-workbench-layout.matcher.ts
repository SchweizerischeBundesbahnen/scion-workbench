...
async function assertActivityLayout(activityLayout: MActivityLayout, locator: Locator): Promise<void> {
  await assertActivityGroup(activityLayout.toolbars.leftTop, locator.locator('wb-layout wb-activity-group[data-group="left-top"]'));
  await assertActivityGroup(activityLayout.toolbars.leftBottom, locator.locator('wb-layout wb-activity-group[data-group="left-bottom"]'));
  await assertActivityGroup(activityLayout.toolbars.rightTop, locator.locator('wb-layout wb-activity-group[data-group="right-top"]'));
  await assertActivityGroup(activityLayout.toolbars.rightBottom, locator.locator('wb-layout wb-activity-group[data-group="right-bottom"]'));
  await assertActivityGroup(activityLayout.toolbars.bottomLeft, locator.locator('wb-layout wb-activity-group[data-group="bottom-left"]'));
  await assertActivityGroup(activityLayout.toolbars.bottomRight, locator.locator('wb-layout wb-activity-group[data-group="bottom-right"]'));
}
