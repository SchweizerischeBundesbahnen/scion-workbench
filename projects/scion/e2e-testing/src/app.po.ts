...
export class AppPO {
   ...
   */
  public async waitUntilAngularStable(): Promise<void> {
    await waitUntilStable(() => this.getLastRenderTime());
  }
  ...
  /**
   * Returns system milliseconds of the last render cycle.
   */
  public getLastRenderTime(): Promise<string> {
    return this.page.locator('app-root').getAttribute('data-last-render').then(lastRender => lastRender!);
  }
