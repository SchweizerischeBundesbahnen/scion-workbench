...
export class MicrofrontendNavigator {
   ...
   */
  public async registerCapability<T extends WorkbenchViewCapability | WorkbenchPopupCapability | WorkbenchDialogCapability | WorkbenchMessageBoxCapability | WorkbenchPerspectiveCapability | WorkbenchPartCapability>(app: 'app1' | 'app2', capability: T): Promise<T & Capability> {
