...
export type WorkbenchMessageBoxCapability = Omit<_WorkbenchMessageBoxCapability, 'type'> & {type: 'messagebox'; properties: {pinToStartPage?: boolean; path: string | '<null>' | '<undefined>'}};
