...
export class RegisterWorkbenchCapabilityPagePO implements MicrofrontendViewPagePO {
   ...
   */
  public async registerCapability<T extends WorkbenchViewCapability | WorkbenchPopupCapability | WorkbenchDialogCapability | WorkbenchMessageBoxCapability | WorkbenchPerspectiveCapability>(capability: T): Promise<T & Capability> {
