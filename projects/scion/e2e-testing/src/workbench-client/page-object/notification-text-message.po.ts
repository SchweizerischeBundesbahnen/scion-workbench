...
/**
 * Page object to interact with {@link NotificationTextMessageComponent} - the built-in notification capability.
 */
export class NotificationTextMessagePO implements WorkbenchNotificationPagePO {
