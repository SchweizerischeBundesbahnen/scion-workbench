...
test.describe('Activity Panel Alignment', () => {
  ...
  test('should align bottom panel (align: left)', async ({appPO, workbenchNavigator}) => {
    ...
    await appPO.header.clickSettingMenuItem({cssClass: ['e2e-panel-alignment', 'e2e-change-panel-alignment-left']});
  ...
  test('should align bottom panel (align: right)', async ({appPO, workbenchNavigator}) => {
    ...
    await appPO.header.clickSettingMenuItem({cssClass: ['e2e-panel-alignment', 'e2e-change-panel-alignment-right']});
  ...
  test('should align bottom panel (align: center)', async ({appPO, workbenchNavigator}) => {
    ...
    await appPO.header.clickSettingMenuItem({cssClass: ['e2e-panel-alignment', 'e2e-change-panel-alignment-center']});
  ...
  test('should align bottom panel (align: justify)', async ({appPO, workbenchNavigator}) => {
    ...
    await appPO.header.clickSettingMenuItem({cssClass: ['e2e-panel-alignment', 'e2e-change-panel-alignment-justify']});
