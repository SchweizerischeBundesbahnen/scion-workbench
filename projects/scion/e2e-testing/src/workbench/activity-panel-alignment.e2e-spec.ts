...
test.describe('Activity Panel Alignment', () => {
  ...
  test('should align bottom panel (left)', async ({appPO, workbenchNavigator}) => {
    ...
    await appPO.setPanelAlignment('left');
  ...
  test('should align bottom panel (right)', async ({appPO, workbenchNavigator}) => {
    await appPO.navigateTo({microfrontendSupport: false, mainAreaInitialPartId: 'part.initial'});
    ...
    await appPO.setPanelAlignment('right');
  ...
  test('should align bottom panel (center)', async ({appPO, workbenchNavigator}) => {
    await appPO.navigateTo({microfrontendSupport: false, mainAreaInitialPartId: 'part.initial'});
    ...
    await appPO.setPanelAlignment('center');
  ...
  test('should align bottom panel (justify)', async ({appPO, workbenchNavigator}) => {
    await appPO.navigateTo({microfrontendSupport: false, mainAreaInitialPartId: 'part.initial'});
    ...
    await appPO.setPanelAlignment('justify');
