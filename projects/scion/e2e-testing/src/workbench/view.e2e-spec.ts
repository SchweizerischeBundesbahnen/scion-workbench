...
test.describe('Workbench View', () => {
  ...
  test('should show hint if not navigated view', async ({appPO, workbenchNavigator}) => {
    ...
    await expect(view.nullViewMessage).toBeVisible();
    ...
    await expect(view.nullViewMessage).not.toBeAttached();
  });
