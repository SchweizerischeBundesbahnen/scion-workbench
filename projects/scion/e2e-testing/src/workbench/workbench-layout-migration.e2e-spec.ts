...
test.describe('Workbench Layout Migration', () => {
  ...
  test('should migrate workbench layout v2 to the latest version', async ({appPO}) => {
    await appPO.navigateTo({
      ...
      localStorage: {
        'scion.workbench.perspective': 'e2e-layout-migration-v2',
        'scion.workbench.perspectives.e2e-layout-migration-v2': '',
      },
    });
  ...
  test('should migrate workbench layout v4 to the latest version', async ({appPO}) => {
    await appPO.navigateTo({
      ...
      microfrontendSupport: false,
      localStorage: {
        'scion.workbench.perspective': 'e2e-layout-migration-v4',
        'scion.workbench.perspectives.e2e-layout-migration-v4': '',
      },
    });
  ...
  test('should migrate workbench layout v5 to the latest version', async ({appPO}) => {
    ...
    expect((await appPO.workbench.part({id: 'part.activity-1'})).navigation.path).toEqual('test-part');
    expect((await appPO.workbench.part({id: 'part.activity-2'})).navigation.path).toEqual('test-part');
  });
});
