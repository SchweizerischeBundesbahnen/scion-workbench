...
test.describe('Workbench Popup', () => {
  ...
  /**
   * Tests that the popup is rendered at the specified position on first render, not initially at position 0/0.
   */
  test('should render popup at specified position on first render', async ({appPO, workbenchNavigator}) => {
    await appPO.navigateTo({microfrontendSupport: false});
    ...
    await popupOpenerPage.open('size-test-page', {
      ...
      delayInitialAnchorCoordinates: true,
