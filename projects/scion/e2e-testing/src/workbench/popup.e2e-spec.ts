...
test.describe('Workbench Popup', () => {
  ...
  test.describe('stick popup to view or part bounds', () => {
    ...
    test('should stick popup anchor to bottom part bounds when scrolling up', async ({appPO, workbenchNavigator}) => {
      await appPO.navigateTo({microfrontendSupport: false});
    ...
    test('should stick popup anchor to bottom part bounds when moving bottom sash up (hidden part)', async ({appPO, workbenchNavigator}) => {
      await appPO.navigateTo({microfrontendSupport: false});
