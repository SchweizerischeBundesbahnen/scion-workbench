...
export class NotificationOpenerPagePO implements WorkbenchViewPagePO, WorkbenchDialogPagePO, WorkbenchPopupPagePO {
  ...
  public async show(component: 'component:notification-page' | 'component:focus-test-page' | 'component:dialog-opener-page' | 'component:popup-opener-page' | 'component:legacy-notification-page', options?: NotificationOpenerPageOptions): Promise<void>;
