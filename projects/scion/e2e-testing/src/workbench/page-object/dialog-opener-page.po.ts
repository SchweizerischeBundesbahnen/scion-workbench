...
export class DialogOpenerPagePO implements WorkbenchViewPagePO, WorkbenchDialogPagePO, WorkbenchPopupPagePO, WorkbenchNotificationPagePO {
  ...
  public async open(component: 'dialog-page' | 'dialog-opener-page' | 'popup-opener-page' | 'focus-test-page' | 'input-field-test-page' | 'size-test-page' | 'large-test-page' | 'workbench-handle-bounds-test-page' | 'workbench-dialog-menu-test-page', options?: WorkbenchDialogOptions & DialogOpenerPageOptions): Promise<void> {
    if (options?.injector) {
