...
export class BlankTestPagePO implements WorkbenchViewPagePO, WorkbenchDialogPagePO, WorkbenchPopupPagePO {

  public readonly locator: Locator;

  constructor(private _locateBy: ViewPO | DialogPO | PopupPO) {
    this.locator = this._locateBy.locator.locator('app-blank-test-page');
  }
