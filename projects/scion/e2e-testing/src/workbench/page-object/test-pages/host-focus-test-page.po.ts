...
/**
 * Page object to interact with {@link HostFocusTestPageComponent}.
 */
export class HostFocusTestPagePO implements WorkbenchViewPagePO, WorkbenchDialogPagePO, WorkbenchPopupPagePO {
  ...
  constructor(private _locateBy: PartPO | ViewPO | DialogPO | PopupPO | DesktopPO) {
    this.locator = _locateBy.locator.locator('app-host-focus-test-page');
