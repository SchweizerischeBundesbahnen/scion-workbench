...
import {ExpectedSubMenuPosition} from './to-have-sub-menu-position.matcher';
...
export interface CustomMatchers<T> extends jasmine.Matchers<T> {
  ...
  toHaveSubMenuPosition(expected: ExpectedSubMenuPosition, expectationFailOutput?: any): boolean;
}
