...
import {ExpectedSciMenuItemLike} from './to-equal-menu.matcher';
...
export interface CustomMatchers<T> extends jasmine.Matchers<T> {
  ...
  toEqualToolbar(expected: ExpectedSciMenuItemLike[], expectationFailOutput?: any): boolean;

  toEqualMenu(expected: ExpectedSciMenuItemLike[], expectationFailOutput?: any): boolean;
}
