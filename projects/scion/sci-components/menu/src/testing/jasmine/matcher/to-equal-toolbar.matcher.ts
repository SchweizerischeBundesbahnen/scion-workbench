...
/**
 * Provides the implementation of {@link CustomMatchers#toEqualToolbar}.
 */
export const toEqualToolbarCustomMatcher: jasmine.CustomMatcherFactories = {
  toEqualToolbar: (util: MatchersUtil): CustomMatcher => {
    return {
